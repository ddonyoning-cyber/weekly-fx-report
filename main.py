...
st.markdown(
    ...
    f'<th style="padding:10px;border:1px solid #ddd;text-align:center;width:10%;">통화</th>'
    f'<th style="padding:10px;border:1px solid #ddd;text-align:center;width:10%;">전망</th>'
    f'<th style="padding:10px;border:1px solid #ddd;text-align:center;width:15%;">예상 밴드</th>'
    f'<th style="padding:10px;border:1px solid #ddd;text-align:center;width:65%;">변동 요인</th>'
    f'</tr>'
    f'<tr>'
